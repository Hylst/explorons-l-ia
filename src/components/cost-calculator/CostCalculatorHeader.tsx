...
import { ArrowLeft, User, ExternalLink, Calculator } from 'lucide-react';
import { useNavigate } from 'react-router-dom';

const CostCalculatorHeader: React.FC = () => {
      ...
      <CardContent className="pt-6">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl font-bold">Calculateur de Coûts IA</h1>
                <p className="text-muted-foreground">
                  Estimez et comparez les coûts des différents services d'IA
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-4 gap-4 text-sm">
          ...
          <div className="flex items-center gap-2 bg-white/50 dark:bg-gray-900/50 p-3 rounded-lg">
            ...
            <span>Comparaisons détaillées</span>
          </div>
          <div className="flex items-center gap-2 bg-white/50 dark:bg-gray-900/50 p-3 rounded-lg">
          ...
          <div className="flex items-center gap-2 bg-white/50 dark:bg-gray-900/50 p-3 rounded-lg">
            ...
            <span>Estimations avancées</span>
          </div>
        </div>
      </CardContent>
    </Card>
